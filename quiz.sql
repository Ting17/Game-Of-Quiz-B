...
('1', 'SPM Sejarah', 'His', 0, 'This is a testing note. For developer view only. Admin can add side note for this particular quiz.', '2017-08-25', '2017-09-22', 1),
('10', 'Mathematics A++', 'English', 0, '<p>Testing update quiz note</p>\r\n', '2017-09-07', '2017-10-25', 2),
('2', 'General English Quiz', 'English', 0, '', '2017-08-25', '2017-10-22', 1),
('4', 'Series: Wall Story', 'English', 4, 'This is a testing note. For developer view only. Admin can add side note for this particular quiz.', '2017-06-20', '2017-10-22', 1),
...
--
ALTER TABLE `question`
  MODIFY `questionID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
